...
<section class="relative min-h-screen flex items-center overflow-hidden">
  ...
  <div class="absolute inset-0">
    <div v-if="sliders.length > 0" class="relative w-full h-full">
      ...
      >
        ...
        <div class="absolute inset-0 bg-gradient-to-r from-black/30 via-black/40 to-black/80"></div>
      ...
      <div v-else-if="sliders.length > 0" class="relative">
        ...
        >
          <div class="text-left text-white max-w-4xl">
            ...
            <!-- Main Title - Split into lines for better formatting -->
            <div class="mb-7" data-aos="fade-up" data-aos-delay="400">
              <h1 class="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-none">
                <div class="mb-2">PT Fiber</div>
                <div class="mb-2">Teknologi Nusantara</div>
              </h1>
            </div>
  ...
  <div v-if="sliders.length > 1" class="absolute top-6 right-6 z-20">
    ...
    <section class="py-16 bg-white dark:bg-gray-800 dark:bg-gray-800 relative overflow-hidden transition-colors duration-200">
      ...
      <div class="max-w-6xl mx-auto px-6 relative z-20">
        <div class="text-center mb-12" data-aos="fade-up">
          ...
          <p class="text-gray-600 dark:text-gray-300 dark:text-gray-300">Membangun masa depan digital Indonesia dengan solusi teknologi terdepan</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div data-aos="fade-right" data-aos-delay="200">
            ...
            <div class="space-y-4 text-gray-600 dark:text-gray-300 dark:text-gray-300 leading-relaxed">
              <p>
    ...
    <section class="py-16 relative overflow-hidden">
      ...
      <div class="max-w-6xl mx-auto px-6 relative z-20">
        <div class="text-center mb-12" data-aos="fade-up">
          ...
          <p class="text-gray-600 dark:text-gray-300 dark:text-gray-300">Solusi lengkap untuk kebutuhan teknologi dan infrastruktur jaringan Anda</p>
        </div>
    ...
    <section class="py-16 bg-white dark:bg-gray-800 dark:bg-gray-800">
      <div class="max-w-6xl mx-auto px-6">
        <div class="text-center mb-12" data-aos="fade-up">
          ...
          <p class="text-gray-600 dark:text-gray-300 dark:text-gray-300">Beberapa proyek terbaru yang telah kami selesaikan</p>
        </div>
        ...
        <div v-else-if="projects.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-700 transform hover:-translate-y-3 hover:scale-[1.02]">
              ...
              <div class="p-5">
                ...
                <!-- Footer -->
                <div class="mt-4 pt-3 border-t border-gray-100 dark:border-gray-700 dark:border-gray-700">
                  <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-1 text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400">
    ...
    <section class="py-16 relative overflow-hidden">
      ...
      <div class="max-w-6xl mx-auto px-6 relative z-20">
        <div class="text-center mb-12" data-aos="fade-up">
          ...
          <p class="text-gray-600 dark:text-gray-300 dark:text-gray-300">Tim profesional yang berpengalaman dalam industri teknologi</p>
        </div>
    ...
    <section class="py-16 bg-white dark:bg-gray-800 relative overflow-hidden">
      ...
      <div class="max-w-6xl mx-auto px-6 relative z-20">
        <div class="text-center mb-12" data-aos="fade-up">
          <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">Galeri</h2>
          <p class="text-gray-600 dark:text-gray-300 dark:text-gray-300">Galeri foto dari berbagai proyek dan kegiatan kami</p>
        </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-gray-200 dark:border-gray-600 dark:border-gray-600">
                <div>
                  ...
                  <div class="flex items-center space-x-2">
                    ...
                    <span class="text-gray-700 dark:text-gray-300 dark:text-gray-300">{{ getProjectStatusText(selectedProject.status) }}</span>
                  </div>
                </div>
